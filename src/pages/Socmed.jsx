...
export default function Socmed() {
  const socmeds = [
    ...
    { name: "Linkedin", img: "/600px-LinkedIn_logo_initials.png", desc: "Linkedin Saya.", link: "https://www.linkedin.com/in/ravikomuhammadraihanyusi", btn: "Kontak Sekarang!" }
  ];
  ...
  return (
    <div className="w-full max-w-5xl px-6 py-12 md:py-24 flex flex-col items-center">
      ...
      >
        <h1 className="text-4xl md:text-6xl font-bold tracking-tighter mb-4">Sosial Media Saya!</h1>
      </motion.div>
